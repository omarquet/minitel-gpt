...
- `documentation/fiche-atelier.md` — fiche d'atelier du montage électronique
  (brochage DIN, **trois montages complets** - pull-up simple alimenté en USB,
  pull-up simple alimenté par le Minitel via MP1584EN, TXS0108E alimenté en USB -,
  tests au multimètre, commandes clavier du Minitel). **La source à maintenir
