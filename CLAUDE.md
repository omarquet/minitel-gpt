...
- `documentation/fiche-atelier.md` — fiche d'atelier du montage électronique
  (brochage DIN, les trois variantes de câblage - TXS0108E, pont diviseur ou
  pull-up simple -, alimentation par le Minitel, tests au multimètre). **La source à maintenir
